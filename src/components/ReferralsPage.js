  ...
  render() {
    return (
      <div>
        ...
        <p>We pay you 2 Naira for every $ bought or sold by your referrals on our site. Your referral bonuses are available for payout to your Bank Account at anytime.</p>
        <br />
        <p>Share the referral link below to start earning Referral Commissions.</p>
        <a href="https://eChange.com/ref/438756" target='_blank' >https://eChange.com/ref/438756</a><br />

        <Panel>
          <h5>Withdraw Referral Commission</h5>
          <h6>Total Commission: 0 NGN</h6>
